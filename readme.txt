...
1. User Agent Information: The browser may send information about the user's browser and operating system.
1. Referrer Information: The browser may send the referrer URL, which is the URL of the page that linked to the archived page.
1. Timestamp Information: The browser may send the timestamp of the request to specify the exact date and time the user wants to view the archived page.
